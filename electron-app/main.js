...
function registerIPCHandlers() {
  ...
  ipcMain.handle('save-config', async (_event, config) => {
    ...
    const sections = {
      ...
      '봇 정보': ['BOT_NAME', 'BOT_EMAIL', 'BOT_ORGANIZATION', 'BOT_TEAM', 'BOT_AUTHORIZED_USERS_EN', 'BOT_AUTHORIZED_USERS_KR', 'BOT_ROLE', 'FILESYSTEM_BASE_DIR', 'RESPONSE_LANGUAGE_SETTING'],
